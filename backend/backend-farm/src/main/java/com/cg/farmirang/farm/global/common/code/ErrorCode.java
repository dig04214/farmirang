package com.cg.farmirang.farm.global.common.code;
...
public enum ErrorCode {
    ...
    UPDATE_DESIGN_THUMBNAIL_ERROR(500, "D004", "대표 디자인을 수정하는 부분에서 오류가 발생했습니다."),

    // 디자인 접근 권한 없는 사용자
    FORBIDDEN_MEMBER(403, "D005", "디자인 접근 권한이 없는 사용자입니다."),
    /**
